...
public class GitHubRepositoryServiceTest {
    ...
    void setup() {
        ...
        this.gitHubRepositoryService = new GitHubRepositoryService(gitHubApiClient, gitHubRepositoryMapper, repositoryJpaRepository);
    }
    ...
    void saveRepository_DataCorrect_ReturnRepository() {
        ...
        when(gitHubApiClient.getRepository("octocat", "Hello-World")).thenReturn(dto);
        when(repositoryJpaRepository.save(any(Repository.class))).thenReturn(new Repository());
